            ...
            <div className="offcanvas-md offcanvas-end bg-body-tertiary" tabIndex="-1" id="sidebarMenu"
                ...
                <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.orders.index') } 
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.meals.index') } 
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cup-hot"
                                    viewBox="0 0 16 16">
                        ...
                        <li className="nav-item">
                            <Link 
                                ...
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-inbox"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.customers.index') } 
                                className="nav-link d-flex align-items-center gap-2">
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.discounts.index') } 
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gift"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.staff.index') } 
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-vcard"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <li className="nav-item">
                            <Link 
                                to={ route('dashboard.reports.index') } 
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journals"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <li className="nav-item">
                            <Link 
                                ...
                                className="nav-link d-flex align-items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-gear"
                                    viewBox="0 0 16 16">
                                    <path
                    ...
                    <ul className="nav flex-column mb-auto">
                        <li 
                            ...
                            <a className="nav-link d-flex align-items-center gap-2" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-power text-danger"
                                    viewBox="0 0 16 16">
